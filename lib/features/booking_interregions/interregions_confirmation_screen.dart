...
class InterregionsConfirmationScreen extends StatefulWidget {
  final String tripId;

  const InterregionsConfirmationScreen({super.key, required this.tripId});

  @override
  State<InterregionsConfirmationScreen> createState() =>
      _InterregionsConfirmationScreenState();
}

class _InterregionsConfirmationScreenState
    extends State<InterregionsConfirmationScreen> {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Départ estimé à ${trip.heureRamassageEstimee}',
                            ),
                            if (confirme) ...[
                              const SizedBox(height: 6),
