...
class InterregionsResultatsScreen extends StatefulWidget {
  final String tripId;

  const InterregionsResultatsScreen({super.key, required this.tripId});

  @override
  State<InterregionsResultatsScreen> createState() =>
      _InterregionsResultatsScreenState();
}

class _InterregionsResultatsScreenState
    extends State<InterregionsResultatsScreen> {
  ...
  Future<void> _reserver() async {
    ...
    try {
      ...
      if (!mounted) return;
      context.go('/passager/home/interregions-confirmation/${widget.tripId}');
    } catch (e) {
      if (!mounted) return;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Départ estimé ${trip.heureRamassageEstimee} · '
